...
public class UserFactoryImpl implements UserFactory {
    ...
    @Override
    public User createWithId(String email, String password, User.Role role, Date createdAt, Long id) throws IllegalStateException {
        validate(email);
        return new User(id, email, password, role, createdAt);
    }

    @Override
    public User createWithoutId(String email, String password, User.Role role, Date createdAt) throws IllegalStateException {
        validate(email);
